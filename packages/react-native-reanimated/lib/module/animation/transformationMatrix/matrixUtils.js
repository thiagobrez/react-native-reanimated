...
function assertVectorsHaveEqualLengths(a, b) {
  ...
  if (__DEV__ && a.length !== b.length) {
    throw new ReanimatedError(
      `Cannot calculate inner product of two vectors of different lengths. Length of ${a.toString()} is ${a.length} and length of ${b.toString()} is ${b.length}.`
    );
  }
}
