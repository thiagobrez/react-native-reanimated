...
import {
  ...
  BounceOut,
  BounceOutData,
} from './animation/Bounce.web.js';
import {
  FadeIn,
  FadeInData,
  FadeOut,
  FadeOutData,
} from './animation/Fade.web.js';
import {
  FlipIn,
  FlipInData,
  FlipOut,
  FlipOutData,
} from './animation/Flip.web.js';
import {
  LightSpeedIn,
  LightSpeedInData,
  LightSpeedOut,
  LightSpeedOutData,
} from './animation/Lightspeed.web.js';
...
import {
  ...
  RollOut,
  RollOutData,
} from './animation/Roll.web.js';
import {
  RotateIn,
  RotateInData,
  RotateOut,
  RotateOutData,
} from './animation/Rotate.web.js';
import {
  SlideIn,
  SlideInData,
  SlideOut,
  SlideOutData,
} from './animation/Slide.web.js';
import {
  StretchIn,
  StretchInData,
  StretchOut,
  StretchOutData,
} from './animation/Stretch.web.js';
import {
  ZoomIn,
  ZoomInData,
  ZoomOut,
  ZoomOutData,
} from './animation/Zoom.web.js';
