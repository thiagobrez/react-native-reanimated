...
declare global {
   ...
   * react-native-reanimated to work properly but it's no longer the case.
   * Your code shouldn't depend on it, we keep it here mainly for backward
   * compatibility for our users.
   */
  var _WORKLET: boolean | undefined;
  /**
   * This ArrayBuffer contains the memory address of `jsi::Runtime` which is
   * the Reanimated UI runtime.
   */
