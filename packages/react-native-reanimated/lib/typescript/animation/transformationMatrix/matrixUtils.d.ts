...
export declare function subtractMatrices<
  T extends AffineMatrixFlat | AffineMatrix,
>(maybeFlatA: T, maybeFlatB: T): T;
export declare function addMatrices<T extends AffineMatrixFlat | AffineMatrix>(
  maybeFlatA: T,
  maybeFlatB: T
): T;
export declare function scaleMatrix<T extends AffineMatrixFlat | AffineMatrix>(
  maybeFlatA: T,
  scalar: number
): T;
export declare function getRotationMatrix(
  angle: number,
  axis?: Axis
): AffineMatrix;
export declare function decomposeMatrix(
  unknownTypeMatrix: AffineMatrixFlat | AffineMatrix
): TransformMatrixDecomposition;
export declare function decomposeMatrixIntoMatricesAndAngles(
